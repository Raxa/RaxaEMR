            ...
            listeners: [{
                fn: function(component, options) {
                    ...
                    if (Ext.getCmp('mainView') == null) {
                        ...
                        if(url.indexOf("#Login") > 0 || (url.indexOf("#Dashboard") < 0 && url.indexOf("screener") < 0 && url.indexOf("registrationextjs4") < 0 && url.indexOf("pharmacy") < 0 && url.indexOf("chw") < 0 && url.indexOf("outpatient") < 0 && url.indexOf("laboratory") < 0 && url.indexOf("admin") < 0 && url.indexOf("billing") < 0 )) {
                            var buttonUrlSettings = this.parent.add({
                                xtype: 'urlSettingsButton',
                                margin: 5,
                                right: 0
