Ext.define("RaxaEmr.view.ProviderAgreement", {
    ...
    config: {
        ...
        '<h1>Grievance Redressal Mechanism</h1><p style="font-size:15px;">If a user has any grievance related to the privacy of information provided to Raxa  he may contact us at support@raxa.io. </p><br>'
        },
